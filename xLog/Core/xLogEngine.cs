...
public static class xLogEngine
{
    ...
    /// </summary>
    public static void Begin(ELogLevel consoleLogLevel= ELogLevel.Info, ELogLevel fileLogLevel = ELogLevel.Debug)
    {
        Resume(Get_Todays_LogFile(), consoleLogLevel, fileLogLevel);
    ...
    /// </summary>
    public static void Begin(string logFile, ELogLevel consoleLogLevel = ELogLevel.Info, ELogLevel fileLogLevel = ELogLevel.Debug)
    {
#if DEBUG_VERBOSE
        xLogEngine.Settings.OutputLevel = ELogLevel.All;
        xLogEngine.Settings.LoggingLevel = ELogLevel.All;
#else
        xLogEngine.Settings.OutputLevel = consoleLogLevel;
        xLogEngine.Settings.LoggingLevel = fileLogLevel;
#endif
    ...
    /// </summary>
    public static void Resume(string logFile, ELogLevel consoleLogLevel = ELogLevel.Info, ELogLevel fileLogLevel = ELogLevel.Debug)
    {
#if DEBUG_VERBOSE
        xLogEngine.Settings.OutputLevel = ELogLevel.All;
        xLogEngine.Settings.LoggingLevel = ELogLevel.All;
    ...
    public static void Start(ELogLevel consoleLogLevel = ELogLevel.Info)
    {
#if DEBUG_VERBOSE
        xLogEngine.Settings.OutputLevel = ELogLevel.All;
#else
