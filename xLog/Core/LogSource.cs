...
/// So the Inventory manager within a Steambot instance can instantiate it's own instance of a <see cref="LogSource"/> and when it uses it to
/// log output all of the lines will be prepended with [Steambot name][ModuleName]
/// </summary>
internal class LogSource : ILog
{
    #region Variables
    /// <summary>
    /// The parent of this source, the parent source's name will appear before this one's in log messages.
    /// </summary>
    private ILog Parent = null;
    ...
    public LogSource(Type Source, ILog Parent = null)
    {
        this.Source = Source;
        this.Parent = Parent;
    ...
    /// <param name="Tag"></param>
    /// <param name="Parent">The parent log-source of this log-source</param>
    public LogSource(string Tag, ILog Parent = null)
    {
        this.Parent = Parent;
        this.Tag = Tag;
    ...
    public LogSource(Func<string> sourceNameFunc, ILog Parent = null)
    {
